	...
	<section id="body" class="page_<?php echo $pagina; ?>">
		<article>
			...
			<p>
				...
				<span class="cv_skill">Technique</span>HTML5, CSS3<br />
				<span class="cv_skill">Git</span><a href="//github.com/angelocovino/website/tree/master/portfolio_data/liferesidential">angelocovino/website/tree/master/portfolio_data/liferesidential</a>
			</p>
			<p class="p_img">
